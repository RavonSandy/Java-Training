...
public class FirstPrg {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
	    ...
	    File ScrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
	      ...
	      FileHandler.copy(ScrFile, new File("C:\\Users\\santhoshg\\Desktop\\Eclipse\\screenshot.png"));

	    wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='added_to_cart wc-forward']")));
